...
class AIAgent:
    ...
    def _build_api_kwargs(self, api_messages: list) -> dict:
        ...
        # Qwen portal preprocessing (must happen before transport gets messages)
        _is_qwen = self._is_qwen_portal()
        _qwen_msgs = None
        if _is_qwen:
            _qwen_msgs = self._qwen_prepare_chat_messages(api_messages)
        ...
        return _ct.build_kwargs(
            ...
            qwen_prepared_messages=_qwen_msgs,
